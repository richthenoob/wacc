...
public class CallNode extends ExprNode {
  ...
  public void check(Visitor visitor, ParserRuleContext ctx) {
    ...
    if(id == null){
      ...
      visitor.addException(ctx, "Couldn't find " + functionName + " in symbol table!");
    } else if(!(id instanceof FunctionIdentifier)){
      String instance = id instanceof ParamIdentifier ? "Param" : "Variable";
      setType(new ErrorType());
      visitor.addException(ctx, "Identifier " + id + " is not an instance of function. Expected: Function. Actual: " + instance);
    } else {
