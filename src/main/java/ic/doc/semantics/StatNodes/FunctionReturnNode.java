...
public class FunctionReturnNode extends StatNode {
    ...
    public void check(Visitor visitor, ParserRuleContext ctx) {
        ...
        if (main) {
            visitor.addException(ctx, "Cannot return from the global scope.");
            ...
            visitor.addTypeException(ctx, exprNode.getInput(), functionType.toString(), exprNode.getType().toString());
        }
